...
list_of_headers = ['local_id','vk_id','cnv_msg_id','Имя собеседника','Фамилия собеседника','ID собеседника','Дата и время (UTC)','Тип отправителя (1 - пользователь, 3 - группа/канал)','ID отправителя','Направление (1 - входящее, 0 - исходящее)','Текст сообщения','Интернет-ссылка на медиа-сообщение','Интернет-ссылка на медиа-сообщение, на которое пользователь ответил']
column_counter = 0
...
for string_from_query in tuple_from_query :
 for column_counter in range (13) :
  ogg_way = ''
  mp3_way = ''
  image_way = ''
  results_image_field = ''
